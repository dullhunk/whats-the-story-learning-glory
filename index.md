...
* Why are core values not reflected in annual reviews? How much of a mismatch exists between our words and our actions as a University? 
    ...
    + Difficult to find and write about? 
    + Learners don't tell their stories? 
    + Teachers don't tell their stories either? 
    + Words like `scholar*` are equally rare and [pedagog*](https://en.wikipedia.org/wiki/Pedagogy) appears exactly zero times in a decade! 
